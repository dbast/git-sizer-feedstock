...
Development: https://github.com/github/git-sizer
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/git-sizer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/git-sizer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `git-sizer` available on your platform:
...
```
pixi search git-sizer --channel conda-forge
```
